...
var ImageView = function (_a) {
    ...
    return (react_1.default.createElement(Card_1.Card, { title: "VIEW", body: react_1.default.createElement("div", { className: 'ivView' },
            react_1.default.createElement("img", { src: imgUrl, alt: "" })), bottom: react_1.default.createElement(Button_1.Button, { text: "BACK", icon: react_1.default.createElement(ArrowBackIos_1.default, null), onClick: function () { return setIsVisible(false); }, outline: true }), close: function () { return setIsVisible(false); } }));
};
