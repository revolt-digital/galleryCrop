...
var ImageCard = function (_a) {
    ...
    return (React.createElement("div", { className: classNames("image-container", {
            "image-selected": (imageSelected === null || imageSelected === void 0 ? void 0 : imageSelected.id) === id,
        }), onClick: handleSelected },
        React.createElement("img", { className: "image-thumbnail", src: url, alt: "" }),
        React.createElement("div", { className: "image-wrapper" },
            React.createElement("div", { className: "icon-container" },
                React.createElement(Button, { text: "edit", transparent: true, onClick: function () {
                        setEditImage(id);
                        setIsEdition(true);
                    } }),
                React.createElement(Button, { text: "delete", onClick: handleDelete, transparent: true })),
            React.createElement("div", { className: "image-description text-ellipsis" },
                React.createElement("span", { className: "image-name-label" }, fileName)))));
};
