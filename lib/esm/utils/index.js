...
export function getCroppedImg(imageSrc, name, pixelCrop) {
...
export function getAspectRatio(wi, he) {
    var w = wi;
    var h = he;
    var d; //gcd
    if (w < 0)
...
export function getImageProperties(file) {
    return __awaiter(this, void 0, void 0, function () {
        var url, imgProps;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
export function getUrlByExtension(url, extension) {
...
export function normalizeFilename(id, filename) {
